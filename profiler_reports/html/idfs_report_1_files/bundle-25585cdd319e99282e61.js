...
/******/ 	(() => {
/******/ 		__webpack_require__.h = () => ("25585cdd319e99282e61")
/******/ 	})();
/******/ 	
  ...
  iframe_createClass(IframeMessenger, [{
    ...
    value: function on(eventName, callback) {
      ...
      function handler(event) {
        if (event instanceof CustomEvent) return callback(event.detail);
      }
      _classPrivateFieldGet(this, _eventBus).addEventListener(eventName, handler, {
        capture: true
      });
      return function () {
        return _classPrivateFieldGet(_this2, _eventBus).removeEventListener(eventName, handler, {
          capture: true
        });
      };
    }
...
function _receive2(event) {
  ...
  if (body.cmd === ACK) {
    ...
    _classPrivateFieldGet(this, _eventBus).dispatchEvent(new CustomEvent(body.cmd, {
      detail: body.payload
    }));
  }
}
...
/******/ })()
;
//# sourceMappingURL=bundle-25585cdd319e99282e61.js.map