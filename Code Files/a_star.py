...
# 4. Heuristic function understanding and reference using - https://chat.openai.com/chat
# 5. Profiler reference - https://github.com/mirecl/pprof , https://pypi.org/project/memory-profiler/
...
def f(board):
        ...
        manhattan_distance += linear_conflict(board.data, constants.goalBoard) # Add linear conflict with manhattan distance
        return manhattan_distance + board.depth


# function that always returns 0 when called 
@cpu
def zero_function(board):
    return 0
